...
<head>
	...
	<title>BengalaMoviles Admin| Insert Product</title>
...
<div class="controls">
<input type="text"    name="productQuantity"  placeholder="Enter Product quantity" value="<?php echo htmlentities($row['productQuantity']);?>" class="span8 tip" required>
</div>
</div>
