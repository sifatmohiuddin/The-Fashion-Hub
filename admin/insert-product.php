...
<div class="controls">
<input type="number"    name="productQuantity"  placeholder="Enter Product quantity" class="span8 tip" required>
</div>
</div>
